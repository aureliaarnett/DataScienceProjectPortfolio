...
# Addressing Question 2: What types of amenities are included for listings with overall ratings under 50%?
print('Question 2: What types of amenities are included for listings with overall ratings under 50%?')
...
print(amenityFreqDF)
amenityFreqDF.to_csv('3-AmenitiesUnder50.csv')
