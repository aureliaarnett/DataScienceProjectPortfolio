...
def processkaggle(dirPath,limitStr):
  ...
  print('Bag of words analysis - Increase Word Count')
  ...
  BoW_items = BagOfWords.most_common(2000) # find most common words
  ...
  BoW_train_set, BoW_test_set = BoWfeaturesets[1334:], BoWfeaturesets[:1334] # create train and test data sets (67% by 33%)
  ...
  print('POS analysis - Increase Word Count')
  ...
  POS_train_set, POS_test_set = POS_featuresets[1334:], POS_featuresets[:1334]
