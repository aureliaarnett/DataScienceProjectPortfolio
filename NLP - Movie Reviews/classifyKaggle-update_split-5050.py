...
# Updating Train/Test split to 50/50
...
def processkaggle(dirPath,limitStr):
  ...
  print('Bag of words analysis - 50/50 Split')
  ...
  BoW_train_set, BoW_test_set = BoWfeaturesets[750:], BoWfeaturesets[:750] # create train and test data sets (50% by 50%)
  ...
  print('POS analysis - 50/50 Split')
  ...
  POS_train_set, POS_test_set = POS_featuresets[750:], POS_featuresets[:750]
