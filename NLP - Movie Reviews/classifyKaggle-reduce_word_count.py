...
# Reducing the word count from 1500 to 1000
...
def processkaggle(dirPath,limitStr):
  ...
  print('Bag of words analysis - Reduce Word Count')
  ...
  BoW_items = BagOfWords.most_common(1000) # find most common words
  ...
  BoW_train_set, BoW_test_set = BoWfeaturesets[667:], BoWfeaturesets[:667] # create train and test data sets (67% by 33%)
  ...
  print('POS analysis - Reduce Word Count')
  ...
  POS_train_set, POS_test_set = POS_featuresets[667:], POS_featuresets[:667]
